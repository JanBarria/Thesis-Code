"""
================================================================================
CHUA CIRCUIT ENCRYPTOR (TRANSMITTER SIDE)
================================================================================
FPGA Implementation of Chaos-Based Secure Communication
De La Salle University - ECE Thesis Project

AUTHORS: Barria & Jusay
SYSTEM: Chua Circuit Encryption Module

DESCRIPTION:
    This module implements the transmitter side of the chaos-based secure
    communication system. It loads a mono .wav audio file, generates a
    chaotic keystream using the Chua circuit, and performs bitwise XOR
    encryption.
...
OUTPUTS:
    ...
    - chua_secret_key.txt: Initial conditions for synchronization
...
class ChuaEncryptor:
    """
    Chua Circuit-based Audio Encryptor (Transmitter)
    """
    ...
    def __init__(self, x0=0.1, y0=0.0, z0=0.0):
        ...
        self.ChuaGenerator = ChuaGenerator
    ...
    def generate_keystream(self, length):
        ...
        generator = self.ChuaGenerator(x0=self.x0, y0=self.y0, z0=self.z0)
    ...
    def save_secret_key(self, filepath):
        ...
        with open(filepath, 'w') as f:
            f.write("CHUA CIRCUIT SECRET KEY (Initial Conditions)\n")
            f.write("=" * 60 + "\n")
    ...
    def save_drive_signal(self, filepath, states):
        ...
        For Chua circuit, we transmit the x state variable
    ...
    def save_transmitter_states(self, filepath, states):
        """
        Save full transmitter states for verification
        
        Args:
            filepath (str): Output file path
            states (numpy.ndarray): Full chaotic states array (x, y, z)
        """
        np.save(filepath, states)
        print(f"Transmitter states saved to: {filepath}")
    ...
    def encrypt_audio(self, input_path, output_path='encrypted_audio.wav', 
        ...
        """
        print("=" * 80)
        print("CHUA CIRCUIT AUDIO ENCRYPTION")
        print("=" * 80)
        ...
        # Save full transmitter states for verification
        states_path = output_path.replace('.wav', '_transmitter_states.npy')
        self.save_transmitter_states(states_path, states)
        ...
        print(f"  4. {states_path}")
        if visualize:
            print(f"  5. {waveform_path}")
            print(f"  6. {spectrogram_path}")
        print("=" * 80)
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("CHUA CIRCUIT AUDIO ENCRYPTOR")
    print("=" * 80)
    ...
    if len(sys.argv) > 1:
        ...
        if not input_file:
            ...
            print("Usage: python chua_encryptor.py <input.wav>")
